...
public class GameEngineScene {
    ...
    public GameObject appendChild(GameObject model){return root.appendChild(model);}
    public GameObject prependChild(GameObject model){return root.prependChild(model);}
    public GameObject removeChild(GameObject model){return root.removeChild(model);}
    ...
    public void setupProjection(float[] mProjectionMatrix){
        ...
        GLActivity a=(GLActivity)this.activity;

...
public class OBJFile {
    ...
    private void parseOBJ(BufferedReader reader) throws IOException {
        ...
        while (line != null) {
            ...
            switch(pieces[0]){
                ...
                case"usemtl":
                    ...
                    break;
                case"v":
                    float x=Float.parseFloat(pieces[1]);
                    XYZ.add(x);
                    float y=Float.parseFloat(pieces[2]);
                    XYZ.add(y);
                    float z=Float.parseFloat(pieces[3]);
                    XYZ.add(z);
                    if(center_i==0){
                        min_box[0]=x;
                        min_box[1]=y;
                        ...
                        if(x<min_box[0])min_box[0]=x;
                        if(y<min_box[1])min_box[1]=y;
                        if(z<min_box[2])min_box[2]=z;
                        if(x>max_box[0])max_box[0]=x;
                        if(y>max_box[1])max_box[1]=y;
                        if(z>max_box[2])max_box[2]=z;
                    }
                    break;
                case"vn":
        ...
        center[0] = (min_box[0]+max_box[0])/2f;
        center[1] = (min_box[1]+max_box[1])/2f;
        center[2] = (min_box[2]+max_box[2])/2f;
